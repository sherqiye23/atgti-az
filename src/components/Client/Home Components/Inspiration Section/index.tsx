...
const sliderInfos: SliderInfosInterface[] = [
    {
        imgUrl: "/images/inspiration-section/heyder-aliyev.jpg",
    ...
    {
        imgUrl: "/images/inspiration-section/ilham-aliyev.jpg",
    ...
    {
        imgUrl: "/images/inspiration-section/mehriban-aliyeva.jpg",
...
export default function InspirationSection() {
    return (
        <>
            <div className="h-[90vh] bg-no-repeat w-full bg-cover bg-[url('/images/inspiration-section/bg-slider.jpg')] bg-fixed">
